...
AstralKeysOptionsFrame = AstralUI:Template('AstralHorizontalOptionsFrame', UIParent)
AstralKeysOptionsFrame:Hide()
AstralKeysOptionsFrame:SetPoint('CENTER', 0, 0)
AstralKeysOptionsFrame.HeaderText:SetText(ASTRAL_KEYS)
AstralKeysOptionsFrame.HeaderText:SetTextColor(1, .82, 0, 1)
AstralKeysOptionsFrame.GuildInfo.title:SetText(ASTRAL_KEYS)
AstralKeysOptionsFrame.GuildInfo.title:SetTextColor(1, .82, 0, 1)
AstralKeysOptionsFrame:SetMovable(true)
AstralKeysOptionsFrame:RegisterForDrag('LeftButton')
AstralKeysOptionsFrame:SetScript('OnDragStart', function(self) self:StartMoving() end)
AstralKeysOptionsFrame:SetScript('OnDragStop', function(self) self:StopMovingOrSizing() end)
AstralKeysOptionsFrame:SetScript('OnKeyDown', function (self, key)
	if key == 'ESCAPE' then
...
AstralKeysOptionsFrame:SetDontSavePosition(true)

-- Paging

local OPTIONS_FRAME_WIDTH = 1000

local options = AstralKeysOptionsFrame or {}
